...
<head>
    ...
    <style>
        ...
        #servicios {
            margin-top: 125px;
            background-image: url('img/boton_isp_01.png'); 
        ...
        <div class="row justify-content-center">
            <div class="col-md-6 col-lg-5">
                <div class="card shadow-sm">
                    <div class="card-body">
                        <h2 class="card-title text-center mb-4">Reporte de Pago</h2>
                        
                        <form action="" method="POST">
                            
                            <div class="mb-3">
                                <label for="nro_contrato" class="form-label">Nro. Contrato:</label>
                                <input type="text" id="nro_contrato" name="nro_contrato" class="form-control" required>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" id="monto" name="monto" step="0.01" min="0" class="form-control" required>
                            </div>

                            <div class="mb-3">
                                <label for="nro_referencia" class="form-label">Nro. de Referencia / Vauche:</label>
                                <input type="text" id="nro_referencia" name="nro_referencia" class="form-control" required>
                            </div>
