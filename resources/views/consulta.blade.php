                ...
                <nav class="menu-desktop d-md-flex justify-content-center align-items-center gap-4 py-2">
                    ...
                    <div class="dropdown mx-3">
                        ...
                        <div class="dropdown-menu">
                            <a href="/residencial" class="dropdown-item">Residencial</a>
            ...
            <div class="row mb-4">
                <div class="col-12">
                    <h4 class="fw-bold">
                        ...
                        <span class="text-alert-red">Bs. 5 848,52 (USD 23,65)</span>
                    </h4>
                </div>
            </div>
                    ...
                    <div class="table-responsive shadow-sm">
                        <table class="table table-bordered table-striped align-middle">
                            <thead class="table-header-custom">
                                <tr><th>N°</th><th>Tipo</th><th>Origen</th><th>Fecha</th><th>USD</th><th>PTR</th><th>Bs</th><th>Saldo</th><th>Imprimir</th></tr>
                            </thead>
                            <tbody>
                                <tr class="table-custom-color"><td>1</td><td>FACT</td><td>WEB</td><td><span id="current-date">01/12/2025</span></td><td>15.00</td><td>0.25</td><td>3.700,00</td><td>5.848,52</td><td><a href="#">PDF</a></td></tr>
                                <tr class="table-custom-color"><td>2</td><td>PAGO</td><td>BCO</td><td>28/11/2025</td><td>-10.00</td><td>-0.15</td><td>-2.500,00</td><td>2.148,52</td><td><a href="#">PDF</a></td></tr>
                                <tr class="table-custom-color"><td>3</td><td>FACT</td><td>WEB</td><td>01/11/2025</td><td>10.00</td><td>0.18</td><td>2.500,00</td><td>4.648,52</td><td><a href="#">PDF</a></td></tr>
                            </tbody>
                            <tfoot>
                                <tr>
                                    <td colspan="9" class="text-end border-0 pt-3">
                                        <button class="btn btn-pay-custom btn-lg">Pagar en línea</button>
                                    </td>
                                </tr>
                            </tfoot>
                        </table>
